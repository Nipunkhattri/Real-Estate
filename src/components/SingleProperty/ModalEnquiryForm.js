...
function ModalEnquiryForm({ data, logo, text = 'Get in Touch', isHeader = 'false' }) {
                                    ...
                                    <Box p='2'>
                                        ...
                                        >
                                            <Stack align='center' spacing={4}>
                                                ...
                                                <Box bgColor='white' p='1' border={'1px'} borderRadius='md' >
                                                    <PhoneInput
                                                ...
                                                <Input w='36' bgColor={'black'} color='white'
                                                    _hover={{ bgColor: 'white', color: 'black', border: '1px solid black' }}
